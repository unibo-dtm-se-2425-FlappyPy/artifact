...
class TestPhysics(unittest.TestCase):
    ...
    def test_bird_has_physics_attributes(self):
        ...
        self.assertEqual(
            self.bird.gravity, 0.5, "Bird should have a correct gravity value"
        )
    ...
    def test_gravity_affects_velocity(self):
        ...
        self.assertEqual(
            self.bird.velocity,
            expected_velocity,
            "Gravity should increase velocity by gravity amount",
        )
    ...
    def test_velocity_affects_position(self):
        ...
        self.assertEqual(
            self.bird.y,
            expected_y,
            "Position should change by velocity AFTER gravity is applied",
        )
    ...
    def test_multiple_updates_accerlate_falling(self):
        ...
        self.assertEqual(
            self.bird.y, expected_y, "Multiple updates should create accelerating fall"
        )
    ...
    def test_jump_sets_upward_velocity(self):
        ...
        self.assertEqual(
            self.bird.velocity,
            expected_velocity,
            "Jump should set velocity to expected velocity",
        )
    ...
    def test_jump_after_falling(self):
        ...
        self.assertLess(
            self.bird.y, fallen_y, "Jump should move bird higher than fallen position"
        )
    ...
    def test_physics_cycle_complete(self):
        ...
        # Should be moving up
        self.assertLess(
            after_jump_y, initial_y, "After jump, bird should be higher than start"
        )
        ...
        self.assertGreater(
            self.bird.y, initial_y, "Eventually gravity should overcome jump"
        )
