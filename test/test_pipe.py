...
class TestPipe(unittest.TestCase):
    ...
    def test_pipe_initialization(self):
        ...
        self.assertEqual(
            self.pipe.x, 100, "Pipe should initialize at correct x position"
        )
        self.assertEqual(self.pipe.width, PIPE_WIDTH, "Pipe should have correct width")
        self.assertEqual(
            self.pipe.gap_center_y, self.test_gap_center, "Pipe should store gap center"
        )
        self.assertEqual(
            self.pipe.gap_size, PIPE_GAP, "Pipe should have correct gap size"
        )
    ...
    def test_pipe_movement(self):
        ...
        self.assertEqual(
            self.pipe.x, expected_x, "Pipe should move left by speed amount"
        )
    ...
    def test_multiple_updates(self):
        ...
        self.assertEqual(
            self.pipe.x, expected_x, "Pipe should move correctly over multiple updates"
        )
    ...
    def test_gap_size_consistency(self):
        ...
        self.assertEqual(
            gap_actual_size, PIPE_GAP, "Actual gap should match PIPE_GAP constant"
        )
    ...
    def test_different_gap_positions(self):
        ...
        self.assertGreater(
            high_pipe.bottom_height,
            high_pipe.top_height,
            "High gap should create taller bottom pipe",
        )
        ...
        self.assertGreater(
            low_pipe.top_height,
            low_pipe.bottom_height,
            "Low gap should create taller top pipe",
        )
    ...
    def test_pipe_boundaries(self):
        ...
        self.assertGreaterEqual(
            self.pipe.top_height, 0, "Top pipe height should be non-negative"
        )
        self.assertGreaterEqual(
            self.pipe.bottom_height, 0, "Bottom pipe height should be non-negative"
        )
        ...
        self.assertLessEqual(
            self.pipe.top_height,
            WINDOW_HEIGHT,
            "Top pipe shouldn't exceed screen height",
        )
        self.assertLessEqual(
            self.pipe.bottom_y + self.pipe.bottom_height,
            WINDOW_HEIGHT,
            "Bottom pipe shouldn't exceed screen height",
        )
