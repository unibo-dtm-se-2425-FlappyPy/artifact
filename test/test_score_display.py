...
class TestScoreDisplay(unittest.TestCase):
    ...
    def test_font_render_creates_valid_surface(self):
        ...
        self.assertTrue(hasattr(text_surface, 'get_width'), "Surface should have get_width() method")
        self.assertTrue(hasattr(text_surface, 'get_height'), "Surface should have get_height() method")
        
        self.assertGreater(text_surface.get_width(), 0, "Text surface should have positive width")
        self.assertGreater(text_surface.get_height(), 0, "Text surface should have positive height")
